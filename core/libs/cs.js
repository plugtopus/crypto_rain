    ...
    function(t, e) {
        ...
        t.cleanData = function(e) {
            ...
            e = e.split(".")[1], n = h + "-" + e, s || (s = i, i = t.Widget), t.expr[":"][n.toLowerCase()] = function(e) {
                ...
                _proto: t.extend({}, s),
                _childConstructors: []
            }), r = new i, r.options = t.widget.extend({}, r.options), t.each(s, function(e, n) {
            ...
            t.fn[i] = function(o) {
                ...
                return o = !r && h.length ? t.widget.extend.apply(null, [o].concat(h)) : o, this.each(r ? function() {
                    ...
                    var e = t.data(this, a);
                    e ? e.option(o || {})._init() : new n(o, this)
                }), l
            }
            ...
            option: function(i, s) {
                ...
                if ("string" == typeof i)
                    if (r = {}, n = i.split("."), i = n.shift(), n.length) {
                        for (a = r[i] = t.widget.extend({}, this.options[i]), o = 0; o < n.length - 1; o++) a[n[o]] = a[n[o]] || {}, a = a[n[o]];
            ...
            _on: function(e, i) {
                var s, n = this;
                i ? (e = s = t(e), this.bindings = this.bindings.add(e)) : (i = e, e = this.element, s = this.widget()), t.each(i, function(i, a) {
                    function o() {
                        return n.options.disabled === !0 || t(this).hasClass("ui-state-disabled") ? void 0 : ("string" == typeof a ? n[a] : a).apply(n, arguments)
                    }
        ...
        t.widget("ui.draggable", t.ui.mouse, {
            ...
            _generatePosition: function(e) {
                ...
                if (this.originalPosition) {
                    ...
                    if (i.grid) {
                        ...
                        a = r && (c - this.offset.click.left < r[0] || c - this.offset.click.left > r[2]) ? c - this.offset.click.left < r[0] ? c + i.grid[0] : c - i.grid[0] : c
                    }
                }
                return {
            ...
            drag: function(e, i) {
                ...
                t.each(s.sortables, function() {
                    ...
                    this.instance.positionAbs = s.positionAbs, this.instance.helperProportions = s.helperProportions, this.instance.offset.click = s.offset.click, this.instance._intersectsWith(this.instance.containerCache) && (a = !0, t.each(s.sortables, function() {
                        return this.instance.positionAbs = s.positionAbs, this.instance.helperProportions = s.helperProportions, this.instance.offset.click = s.offset.click, this != o && this.instance._intersectsWith(this.instance.containerCache) && t.ui.contains(o.instance.element[0], this.instance.element[0]) && (a = !1), a
            ...
            drag: function(e, i) {
                for (var s = t(this).data("draggable"), n = s.options, a = n.snapTolerance, o = i.offset.left, r = o + s.helperProportions.width, h = i.offset.top, l = h + s.helperProportions.height, c = s.snapElements.length - 1; c >= 0; c--) {
                    ...
                    if (o > u - a && d + a > o && h > p - a && f + a > h || o > u - a && d + a > o && l > p - a && f + a > l || r > u - a && d + a > r && h > p - a && f + a > h || r > u - a && d + a > r && l > p - a && f + a > l) {
                        if ("inner" != n.snapMode) {
            ...
            switch (s) {
                ...
                case "pointer":
                    var d = (e.positionAbs || e.position.absolute).left + (e.clickOffset || e.offset.click).left,
                        ...
                        f = t.ui.isOver(p, d, c, h, i.proportions.height, i.proportions.width);
                    return f;
                case "touch":
                    return (o >= c && u >= o || r >= c && u >= r || c > o && r > u) && (n >= h && l >= n || a >= h && l >= a || h > n && a > l);
                default:
                    return !1
            }
        }, t.ui.ddmanager = {
    ...
    function(t) {
        t.widget("ui.resizable", t.ui.mouse, {
            ...
            _updateVirtualBoundaries: function(t) {
                ...
                }, (this._aspectRatio || t) && (e = o.minHeight * this.aspectRatio, n = o.minWidth / this.aspectRatio, s = o.maxHeight * this.aspectRatio, a = o.maxWidth / this.aspectRatio, e > o.minWidth && (o.minWidth = e), n > o.minHeight && (o.minHeight = n), s < o.maxWidth && (o.maxWidth = s), a < o.maxHeight && (o.maxHeight = a)), this._vBoundaries = o
            },
    ...
    t.effects = {
        ...
        function(e, i) {
            ...
            function n(t) {
                var i = c(),
                    s = i._rgba = [];
                return t = t.toLowerCase(), g(l, function(e, n) {
                    var a, o = n.re.exec(t),
                        r = o && n.parse(o),
                        h = n.space || "rgba";
                    return r ? (a = i[h](r), i[u[h].cache] = a[u[h].cache], s = i._rgba = a._rgba, !1) : void 0
                }), s.length ? ("0,0,0,0" === s.join() && e.extend(s, o.transparent), i) : o[t]
            }
            ...
            f.style.cssText = "background-color:rgba(1,1,1,.5)", p.rgba = f.style.backgroundColor.indexOf("rgba") > -1, g(u, function(t, e) {
                ...
                parse: function(a, r, h, l) {
                    ...
                    var d = this,
                        p = e.type(a),
                        f = this._rgba = [];
                    return r !== i && (a = [a, r, h, l], p = "array"), "string" === p ? this.parse(n(a) || o._default) : "array" === p ? (g(u.rgba.props, function(t, e) {
                        f[e.idx] = s(a[e.idx], e)
                    }), this) : "object" === p ? (a instanceof c ? g(u, function(t, e) {
                ...
                is: function(t) {
                    ...
                    return g(u, function(t, n) {
                        var a, o = e[n.cache];
                        return o && (a = s[n.cache] || n.to && n.to(s._rgba) || [], g(n.props, function(t, e) {
                ...
                transition: function(t, e) {
                    ...
                    return i = i[a.cache], g(a.props, function(t, n) {
                        var a = n.idx,
                            ...
                            l = i[a],
                            c = d[n.type] || {};
                        null !== l && (null === o ? h[a] = l : (c.mod && (l - o > c.mod / 2 ? o += c.mod : o - l > c.mod / 2 && (o -= c.mod)), h[a] = s((l - o) * e + o, n)))
                    }), this[n](h)
                },
                blend: function(t) {
                ...
                var e, i, s = t[0] / 255,
                    ...
                    c = r + h,
                    u = .5 * c;
                return e = h === r ? 0 : s === r ? 60 * (n - a) / l + 360 : n === r ? 60 * (a - s) / l + 120 : 60 * (s - n) / l + 240, i = 0 === u || 1 === u ? u : .5 >= u ? l / c : l / (2 - c), [Math.round(e) % 360, i, u, null == o ? 1 : o]
                ...
                c.fn[t] = function(t) {
                    ...
                    var n, h = e.type(t),
                        u = "array" === h || "object" === h ? t : arguments,
                        d = this[o].slice();
                    return g(a, function(t, e) {
                        var i = u["object" === h ? t : e.idx];
                        null == i && (i = d[e.idx]), d[e.idx] = s(i, e)
                    }), l ? (n = c(l(d)), n[o] = d, n) : c(d)
                }, g(a, function(i, s) {
                    c.fn[i] || (c.fn[i] = function(n) {
                        var a, o = e.type(n),
                            ...
                            l = this[r](),
                            c = l[s.idx];
                        return "undefined" === o ? c : ("function" === o && (n = n.call(this, c), o = e.type(n)), null == n && s.empty ? this : ("string" === o && (a = h.exec(n), a && (n = c + parseFloat(a[2]) * ("+" === a[1] ? 1 : -1))), l[s.idx] = n, this[r](l)))
                    })
                })
            }), g(r, function(t, i) {
                e.cssHooks[i] = {
        ...
        function() {
            ...
            t.extend(t.effects, {
                version: "1.9.1",
                save: function(t, e) {
                    for (var i = 0; i < e.length; i++) null !== e[i] && t.data(s + e[i], t[0].style[e[i]])
                },
                restore: function(t, i) {
                    var n, a;
                    for (a = 0; a < i.length; a++) null !== i[a] && (n = t.data(s + i[a]), n === e && (n = ""), t.css(i[a], n))
                },
                ...
                effect: function() {
                    ...
                    return t.fx.off || !r && !h ? a ? this[a](s.duration, s.complete) : this.each(function() {
                        s.complete && s.complete.call(this)
                    }) : r ? o === !1 ? this.each(e) : this.queue(o || "fx", e) : h.call(this, {
                        options: s,
                        duration: s.duration,
                        callback: s.complete,
                        mode: s.mode
            ...
            _create: function() {
                ...
                this.prevShow = this.prevHide = t(), this.element.addClass("ui-accordion ui-widget ui-helper-reset"), this.headers = this.element.find(s.header).addClass("ui-accordion-header ui-helper-reset ui-state-default ui-corner-all"), this._hoverable(this.headers), this._focusable(this.headers), this.headers.next().addClass("ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom").hide(), s.collapsible || s.active !== !1 && null != s.active || (s.active = 0), s.active < 0 && (s.active += this.headers.length), this.active = this._findActive(s.active).addClass("ui-accordion-header-active ui-state-active").toggleClass("ui-corner-all ui-corner-top"), this.active.next().addClass("ui-accordion-content-active").show(), this._createIcons(), this.refresh(), this.element.attr("role", "tablist"), this.headers.attr("role", "tab").each(function(e) {
                    var s = t(this),
                        ...
                        a = s.next(),
                        o = a.attr("id");
                    n || (n = i + "-header-" + e, s.attr("id", n)), o || (o = i + "-panel-" + e, a.attr("id", o)), s.attr("aria-controls", o), a.attr("aria-labelledby", n)
            ...
            e._create = function() {
                if (this.options.navigation) {
                    ...
                    a && s.add(n).each(function(i) {
                        return t.contains(this, a) ? (e.options.active = Math.floor(i / 2), !1) : void 0
                    })
                }
                i.call(this)
            }
        ...
        t.widget("ui.button", {
            ...
            _create: function() {
                ...
                var o = this,
                    ...
                    d = "ui-state-focus";
                null === r.label && (r.label = "input" === this.type ? this.buttonElement.val() : this.buttonElement.html()), this.buttonElement.addClass(a).attr("role", "button").bind("mouseenter" + this.eventNamespace, function() {
                    r.disabled || (t(this).addClass("ui-state-hover"), this === e && t(this).addClass("ui-state-active"))
                    ...
                    return r.disabled || n ? !1 : (t(this).toggleClass("ui-state-active"), void o.buttonElement.attr("aria-pressed", o.element[0].checked))
                    ...
                    return r.disabled ? !1 : (t(this).addClass("ui-state-active"), e = this, void o.document.one("mouseup", function() {
                        e = null
                    }))
        ...
        $.extend(Datepicker.prototype, {
            ...
            parseDate: function(t, e, i) {
                ...
                for (var n = (i ? i.dayNamesShort : null) || this._defaults.dayNamesShort, a = (i ? i.dayNames : null) || this._defaults.dayNames, o = (i ? i.monthNamesShort : null) || this._defaults.monthNamesShort, r = (i ? i.monthNames : null) || this._defaults.monthNames, h = -1, l = -1, c = -1, u = -1, d = !1, p = function(e) {
                    ...
                    if ($.each(n, function(t, i) {
                            var s = i[1];
                            return e.substr(v, s.length).toLowerCase() == s.toLowerCase() ? (a = i[0], v += s.length, !1) : void 0
                        }), -1 != a) return a + 1;
                ...
                if (-1 == h ? h = (new Date).getFullYear() : 100 > h && (h += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (s >= h ? 0 : -100)), u > -1)
                    for (l = 1, c = u;;) {
                        var w = this._getDaysInMonth(h, l - 1);
                        if (w >= c) break;
                        l++, c -= w
                    }
                var b = this._daylightSavingAdjust(new Date(h, l - 1, c));
                ...
                for (var D = this._get(t, "showWeek"), P = this._get(t, "dayNames"), I = (this._get(t, "dayNamesShort"), this._get(t, "dayNamesMin")), M = this._get(t, "monthNames"), T = this._get(t, "monthNamesShort"), S = this._get(t, "beforeShowDay"), A = this._get(t, "showOtherMonths"), z = this._get(t, "selectOtherMonths"), H = (this._get(t, "calculateWeek") || this.iso8601Week, this._getDefaultDate(t)), N = "", E = 0; E < o[0]; E++) {
                    ...
                    for (var O = 0; O < o[1]; O++) {
                        var F = this._daylightSavingAdjust(new Date(f, p, t.selectedDay)),
                            ...
                            j = "";
                        if (l) {
                            if (j += '<div class="ui-datepicker-group', o[1] > 1) switch (O) {
                                case 0:
                        ...
                        j += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix' + R + '">' + (/all|left/.test(R) && 0 == E ? i ? b : v : "") + (/all|right/.test(R) && 0 == E ? i ? v : b : "") + this._generateMonthYearHeader(t, p, f, u, d, E > 0 || O > 0, M, T) + '</div><table class="ui-datepicker-calendar"><thead><tr>';
                        for (var L = D ? '<th class="ui-datepicker-week-col">' + this._get(t, "weekHeader") + "</th>" : "", Y = 0; 7 > Y; Y++) {
                            var B = (Y + C) % 7;
                            L += "<th" + ((Y + C + 6) % 7 >= 5 ? ' class="ui-datepicker-week-end"' : "") + '><span title="' + P[B] + '">' + I[B] + "</span></th>"
                        }
                        j += L + "</tr></thead><tbody>";
                        ...
                        var q = (this._getFirstDayOfMonth(f, p) - C + 7) % 7,
                            Q = Math.ceil((q + K) / 7),
                            U = l && this.maxRows > Q ? this.maxRows : Q;
                        this.maxRows = U;
                        for (var V = this._daylightSavingAdjust(new Date(f, p, 1 - q)), X = 0; U > X; X++) {
                            j += "<tr>";
                            for (var G = D ? '<td class="ui-datepicker-week-col">' + this._get(t, "calculateWeek")(V) + "</td>" : "", Y = 0; 7 > Y; Y++) {
                                var Z = S ? S.apply(t.input ? t.input[0] : null, [V]) : [!0, ""],
                                    J = V.getMonth() != p,
                                    te = J && !z || !Z[0] || u && u > V || d && V > d;
                                G += '<td class="' + ((Y + C + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (J ? " ui-datepicker-other-month" : "") + (V.getTime() == F.getTime() && p == t.selectedMonth && t._keyEvent || H.getTime() == V.getTime() && H.getTime() == F.getTime() ? " " + this._dayOverClass : "") + (te ? " " + this._unselectableClass + " ui-state-disabled" : "") + (J && !A ? "" : " " + Z[1] + (V.getTime() == c.getTime() ? " " + this._currentClass : "") + (V.getTime() == e.getTime() ? " ui-datepicker-today" : "")) + '"' + (J && !A || !Z[2] ? "" : ' title="' + Z[2] + '"') + (te ? "" : ' data-handler="selectDay" data-event="click" data-month="' + V.getMonth() + '" data-year="' + V.getFullYear() + '"') + ">" + (J && !A ? "&#xa0;" : te ? '<span class="ui-state-default">' + V.getDate() + "</span>" : '<a class="ui-state-default' + (V.getTime() == e.getTime() ? " ui-state-highlight" : "") + (V.getTime() == c.getTime() ? " ui-state-active" : "") + (J ? " ui-priority-secondary" : "") + '" href="#">' + V.getDate() + "</a>") + "</td>", V.setDate(V.getDate() + 1), V = this._daylightSavingAdjust(V)
                            }
                            j += G + "</tr>"
                        }
                        p++, p > 11 && (p = 0, f++), j += "</tbody></table>" + (l ? "</div>" + (o[0] > 0 && O == o[1] - 1 ? '<div class="ui-datepicker-row-break"></div>' : "") : ""), W += j
                    }
                    N += W
                }
                return N += k + ($.ui.ie6 && !t.inline ? '<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>' : ""), t._keyEvent = !1, N
            },
            _generateMonthYearHeader: function(t, e, i, s, n, a, o, r) {
                ...
                if (a || !h) d += '<span class="ui-datepicker-month">' + o[e] + "</span>";
                    ...
                    for (var g = 0; 12 > g; g++)(!p || g >= s.getMonth()) && (!f || g <= n.getMonth()) && (d += '<option value="' + g + '"' + (g == e ? ' selected="selected"' : "") + ">" + r[g] + "</option>");
                    d += "</select>"
                }
        ...
        t.widget("ui.dialog", {
            ...
            _createButtons: function(e) {
                ...
                this.uiDialogButtonPane.remove(), this.uiButtonSet.empty(), "object" == typeof e && null !== e && t.each(e, function() {
                    ...
                    var n = t("<button type='button'></button>").attr(s, !0).unbind("click").click(function() {
            ...
            _makeDraggable: function() {
                ...
                this.uiDialog.draggable({
                    ...
                    stop: function(n, a) {
                        s.position = [a.position.left - i.document.scrollLeft(), a.position.top - i.document.scrollTop()], t(this).removeClass("ui-dialog-dragging"), i._trigger("dragStop", n, e(a)), t.ui.dialog.overlay.resize()
                    }
                })
            },
    ...
    function(t) {
        ...
        t.effects.effect.blind = function(s, n) {
            ...
            h.parent().is(".ui-effects-wrapper") ? t.effects.save(h.parent(), l) : t.effects.save(h, l), h.show(), a = t.effects.createWrapper(h).css({
                overflow: "hidden"
            }), o = a[p](), r = parseFloat(a.css(f)) || 0, m[p] = v ? o : 0, g || (h.css(d ? "bottom" : "right", 0).css(d ? "top" : "left", "auto").css({
                position: "absolute"
    ...
    function(t) {
        t.effects.effect.bounce = function(e, i) {
            ...
            for ((c || l) && r.push("opacity"), t.effects.save(o, r), o.show(), t.effects.createWrapper(o), d || (d = o["top" === v ? "outerHeight" : "outerWidth"]() / 3), c && (a = {
                opacity: 1
            }, a[v] = 0, o.css("opacity", 0).css(v, _ ? 2 * -d : 2 * d).animate(a, g, m)), l && (d /= Math.pow(2, p - 1)), a = {}, a[v] = 0, s = 0; p > s; s++) n = {}, n[v] = (_ ? "-=" : "+=") + d, o.animate(n, g, m).animate(a, g, m), d = l ? 2 * d : d / 2;
            l && (n = {
                opacity: 0
    ...
    function(t) {
        t.effects.effect.shake = function(e, i) {
            var s, n = t(this),
                ...
                v = n.queue(),
                _ = v.length;
            for (t.effects.save(n, a), n.show(), t.effects.createWrapper(n), f[d] = (p ? "-=" : "+=") + h, g[d] = (p ? "+=" : "-=") + 2 * h, m[d] = (p ? "-=" : "+=") + 2 * h, n.animate(f, u, e.easing), s = 1; l > s; s++) n.animate(g, u, e.easing).animate(m, u, e.easing);
        ...
        t.widget("ui.menu", {
            ...
            _keydown: function(e) {
                ...
                switch (e.keyCode) {
                    ...
                    case t.ui.keyCode.ESCAPE:
                        ...
                        break;
                    default:
                        h = !1, n = this.previousFilter || "", a = String.fromCharCode(e.keyCode), o = !1, clearTimeout(this.filterTimer), a === n ? o = !0 : a = n + a, r = new RegExp("^" + i(a), "i"), s = this.activeMenu.children(".ui-menu-item").filter(function() {
                            return r.test(t(this).children("a").text())
                        }), s = o && -1 !== s.index(this.active.next()) ? this.active.nextAll(".ui-menu-item") : s, s.length || (a = String.fromCharCode(e.keyCode), r = new RegExp("^" + i(a), "i"), s = this.activeMenu.children(".ui-menu-item").filter(function() {
                            return r.test(t(this).children("a").text())
            ...
            refresh: function() {
                var e, i = this.options.icons.submenu,
                    s = this.element.find(this.options.menus + ":not(.ui-menu)").addClass("ui-menu ui-widget ui-widget-content ui-corner-all").hide().attr({
                        role: this.options.role,
                        "aria-hidden": "true",
                        "aria-expanded": "false"
                    });
                ...
                }), e.children(".ui-state-disabled").attr("aria-disabled", "true"), s.each(function() {
                    var e = t(this),
                        s = e.prev("a"),
    ...
    function(t, e) {
        ...
        t.position = {
            scrollbarWidth: function() {
                if (n !== e) return n;
                var i, s,
                    a = t("<div style='display:block;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"),
                    o = a.children()[0];
            ...
            }), 1 === w.length && (w[1] = w[0]), "right" === e.at[0] ? m.left += d : "center" === e.at[0] && (m.left += d / 2), "bottom" === e.at[1] ? m.top += f : "center" === e.at[1] && (m.top += f / 2), n = i(x.at, d, f), m.left += n[0], m.top += n[1], this.each(function() {
                var h, l, c = t(this),
                    u = c.outerWidth(),
                    p = c.outerHeight(),
                    y = s(this, "marginLeft"),
                    ...
                    P = t.extend({}, m),
                    I = i(x.my, c.outerWidth(), c.outerHeight());
                "right" === e.my[0] ? P.left -= u : "center" === e.my[0] && (P.left -= u / 2), "bottom" === e.my[1] ? P.top -= p : "center" === e.my[1] && (P.top -= p / 2), P.left += I[0], P.top += I[1], t.support.offsetFractions || (P.left = r(P.left), P.top = r(P.top)), h = {
                    marginLeft: y,
                    marginTop: k
                }, t.each(["left", "top"], function(i, s) {
                    t.ui.position[w[i]] && t.ui.position[w[i]][s](P, {
                        targetWidth: d,
                        targetHeight: f,
                        elemWidth: u,
                        elemHeight: p,
                    ...
                    u > d && o(i + s) < d && (h.horizontal = "center"), p > f && o(n + r) < f && (h.vertical = "middle"), h.important = a(o(i), o(s)) > a(o(n), o(r)) ? "horizontal" : "vertical", e.using.call(this, t, h)
                }), c.offset(t.extend(P, {
                    using: l
                }))
            })
            ...
            flip: {
                left: function(t, e) {
                    var i, s, n = e.within,
                        ...
                        f = -2 * e.offset[0];
                    0 > c ? (i = t.left + d + p + f + e.collisionWidth - r - a, (0 > i || i < o(c)) && (t.left += d + p + f)) : u > 0 && (s = t.left - e.collisionPosition.marginLeft + d + p + f - h, (s > 0 || o(s) < u) && (t.left += d + p + f))
                },
                top: function(t, e) {
                    var i, s, n = e.within,
                        ...
                        g = -2 * e.offset[1];
                    0 > c ? (s = t.top + p + f + g + e.collisionHeight - r - a, t.top + p + f + g > c && (0 > s || s < o(c)) && (t.top += p + f + g)) : u > 0 && (i = t.top - e.collisionPosition.marginTop + p + f + g - h, t.top + p + f + g > u && (i > 0 || o(i) < u) && (t.top += p + f + g))
                }
            },
            flipfit: {
                left: function() {
    ...
    function(t) {
        ...
        t.widget("ui.slider", t.ui.mouse, {
            ...
            _mouseCapture: function(e) {
                ...
                }), u.range === !0 && this.values(1) === u.min && (o += 1, a = t(this.handles[o])), r = this._start(e, o), r === !1 ? !1 : (this._mouseSliding = !0, this._handleIndex = o, a.addClass("ui-state-active").focus(), h = a.offset(), l = !t(e.target).parents().andSelf().is(".ui-slider-handle"), this._clickOffset = l ? {
                    left: 0,
                    top: 0
                } : {
        ...
        t.widget("ui.tabs", {
            ...
            _create: function() {
                ...
                this.running = !1, this.element.addClass("ui-tabs ui-widget ui-widget-content ui-corner-all").toggleClass("ui-tabs-collapsible", i.collapsible).delegate(".ui-tabs-nav > li", "mousedown" + this.eventNamespace, function(e) {
                    ...
                    return t(i).attr("aria-controls") === n ? (s = e, !1) : void 0
                }), null === s && (s = this.tabs.index(this.tabs.filter(".ui-tabs-active"))), (null === s || -1 === s) && (s = this.tabs.length ? 0 : !1)), s !== !1 && (s = this.tabs.index(this.tabs.eq(s)), -1 === s && (s = i.collapsible ? !1 : 0)), i.active = s, !i.collapsible && i.active === !1 && this.anchors.length && (i.active = 0), t.isArray(i.disabled) && (i.disabled = t.unique(i.disabled.concat(t.map(this.tabs.filter(".ui-state-disabled"), function(t) {
            ...
            _trigger: function(t, e, i) {
                ...
                return s ? ("beforeActivate" === t && i.newTab.length ? s = this._super("select", e, {
                    tab: i.newTab.find(".ui-tabs-anchor")[0],
                    panel: i.newPanel[0],
                    index: i.newTab.closest("li").index()
                }) : "activate" === t && i.newTab.length && (s = this._super("show", e, {
                    tab: i.newTab.find(".ui-tabs-anchor")[0],
                    panel: i.newPanel[0],
                    index: i.newTab.closest("li").index()
                })), s) : !1
            ...
            _toggle: function(t, e) {
                ...
                }) : (e.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active"), o.hide(), s()))) : this._super(t, e)
            }
        }))
    }(jQuery),
    function(t) {
        ...
        t.widget("ui.tooltip", {
            ...
            open: function(e) {
                ...
                if (s.length) {
                    if (this.options.track && s.data("ui-tooltip-id")) return this._find(s).position(t.extend({ of: s
                    }, this.options.position)), void this._off(this.document, "mousemove");
                    s.attr("title") && s.data("ui-tooltip-title", s.attr("title")), s.data("tooltip-open", !0), e && "mouseover" === e.type && s.parents().each(function() {
                        var e;
            ...
            _updateContent: function(t, e) {
                ...
                return "string" == typeof s ? this._open(e, t, s) : (i = s.call(t[0], function(i) {
                    t.data("tooltip-open") && n._delay(function() {
                        this._open(e, t, i)
                    })
            ...
            _open: function(i, s, n) {
                ...
                if (n) {
                    ...
                    s.is("[title]") && (i && "mouseover" === i.type ? s.attr("title", "") : s.removeAttr("title")), o = this._tooltip(s), e(s, o.attr("id")), o.find(".ui-tooltip-content").html(n), this.options.track && i && /^mouse/.test(i.originalEvent.type) ? (this._on(this.document, {
                        mousemove: a
                    ...
                    }, i && "mouseover" !== i.type || (r.mouseleave = "close"), i && "focusin" !== i.type || (r.focusout = "close"), this._on(s, r)
                }
            },
            close: function(e) {
                var s = this,
                ...
                }), n.removeData("tooltip-open"), this._off(n, "mouseleave focusout keyup"), n[0] !== this.element[0] && this._off(n, "remove"), this._off(this.document, "mousemove"), e && "mouseleave" === e.type && t.each(this.parents, function(t, e) {
                    e.element.title = e.title, delete s.parents[t]
